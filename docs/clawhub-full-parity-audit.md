...
The main remaining gap is not basic marketplace lifecycle anymore. The remaining gap is depth outside the package marketplace: full account/org/auth model, browser OAuth, hosted skill lifecycle, community surfaces, and broader ClawHub test/docs coverage.
